...
class DataManager {
    ...
    private func buildArticlesArray() {
        articles.append(Article(source: Source(id: "cnn",
                                ...
                                description: "The family of astronaut Neil Armstrong was paid $6 million by a hospital as part of a wrongful death settlement, according to a report from The New York Times.",
        ...
        articles.append(Article(source: Source(id: nil,
                                ...
                                description: "Successive governments in Pakistan did not tell the truth to the United States, in particular in the last 15 years, Pakistani Prime Minister Imran Khan said on Tuesday, adding that there were 40 different terror groups operating in his country.",
        ...
        articles.append(Article(source: Source(id: "engadget",
                                ...
                                description: "Nintendo reportedly told customer support reps to offer free Joy-Con repairs and to issue refunds for previous repairs.",
        ...
        articles.append(Article(source: Source(id: "fox-news",
                                ...
                                description: "Embattled Puerto Rico Gov. Ricardo Rosselló told Fox News on Tuesday that he wants a conversation with President Trump, saying he disagreed with Trump’s claim that he is a “terrible governor.”",
                                urlToImage: nil,
